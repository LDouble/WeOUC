...
Page({
  data: {
    page: 0,
    list: [
      { id: 0, 'type': 'jwc', name: '教务公告',storage:[], url: '/news/lists', enabled: {guest:true, student:true, teacher:true} },
      { id: 1, 'type': 'hq', name: 'OA公告', storage: [], url: '/news/lists', enabled: {guest:true, student:true, teacher:true} },
      { id: 2, 'type': 'xs', name: '学术讲座', storage: [], url: '/news/lists', enabled: {guest:true, student:true, teacher:true} },
    ],
    'active': {
      id: 0,
      'type': 'jwc',
