...
Page({
  data: {
    ...
    _time: [ //课程时间与指针位置的映射，{begin:课程开始,end:结束时间,top:指针距开始top格数}
      ...
      { begin: '15:30', end: '16:50', beginTop: 840, endTop: 900 },
      { begin: '16:51', end: '16:59', beginTop: 900, endTop: 910 },
      { begin: '17:00', end: '18:20', beginTop: 915, endTop: 930 },
      { begin: '18:21', end: '18:59', beginTop: 1000, endTop: 1050 },
      { begin: '19:00', end: '20:20', beginTop: 1258, endTop: 1458 },
      { begin: '20:21', end: '20:29', beginTop: 1362, endTop: 1662 },
    ],
    timelineTop: 0,
    scroll: {
      left: 0
